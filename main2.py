...
sessionStorage = {}
by = 'Привет! Купи слона!'
up = 'слона'
ans = 'Слона можно найти на Яндекс.Маркете! А теперь купи кролика!'
adress = "https://market.yandex.ru/search?text=слон"
...
def handle_dialog(req, res):
    ...
    if req['request']['original_utterance'].lower() in [
        ...
        if up == 'слона':
            by = 'Привет! Купи кролика!'
            up = 'кролика'
            ans = 'Кролика можно найти на Яндекс.Маркете!'
            adress = 'https://market.yandex.ru/catalog--miagkie-igrushki/59699/list?text=кролик&hid=10682610&rt=10&was_redir=1&rs=eJwzYgpgBAABcwCG&local-offers-first=0'
            sessionStorage[user_id] = {
                'suggests': [
                    "Не хочу.",
                    "Не буду.",
    ...
    res['response']['text'] = \
        f"Все говорят '{req['request']['original_utterance']}', а ты купи {up}!"
    res['response']['buttons'] = get_suggests(user_id)
